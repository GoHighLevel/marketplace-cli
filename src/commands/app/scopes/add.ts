...
import { checkboxSearch, confirm, input } from '../../../lib/shared/prompts.js'
...
export default class AppScopesAdd extends GhlCommand {
  ...
  protected async execute(): Promise<void> {
    ...
    try {
      ...
      this.error(errorMessage(error, 'Invalid scope arguments'))
    }
