...
export default class AppMediaUpload extends Command {
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      this.error(error instanceof Error ? error.message : 'Invalid file arguments')
    }
    ...
    try {
      ...
      this.error(error instanceof Error ? error.message : 'Failed to upload media')
    }
  }
}
